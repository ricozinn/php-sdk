...
class Cart
{
	...
	{
		return self::$sdk->put('carts/'.self::$identifier.'/items/'.$id, $data);
	}
	...
	{
		return self::$sdk->delete('carts/'.self::$identifier.'/items/'.$id);
	}

	public static function Item($id)
	{
		return self::$sdk->get('carts/'.self::$identifier.'/items/'.$id);
	}
